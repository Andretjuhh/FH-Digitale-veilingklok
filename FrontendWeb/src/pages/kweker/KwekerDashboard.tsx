...
import Table, {DataTable, Column} from '../../components/elements/Table';
...
export default function KwekerDashboard() {
	...
	const [createdProducts, setCreatedProducts] = useState<ProductOutputDto[]>([]);
											...
											<div className="modal-body">
												...
												>
													...
													<div className="form-row">
														<FormInputField
															id="minimumPrice"
															label="Minimum prijs (Лил)"
															type="number"
															step="0.01"
															{...register('minimumPrice', {required: 'Minimum prijs is verplicht', min: 0})}
															isError={!!errors.minimumPrice}
															error={errors.minimumPrice?.message as string}
														/>
													</div>
													...
													<div className="form-row">
														<FormInputField
															id="imageBase64"
															label="Afbeelding (Base64)"
															{...register('imageBase64')}
															isError={!!errors.imageBase64}
															error={errors.imageBase64?.message as string}
														/>
													</div>
															...
															<div className="product-meta">
																<div className="product-meta-header">
																	...
																	<div className="product-price">
																		{formatEur(previewProduct.auctionPrice ?? previewProduct.minimumPrice)}
																	</div>
																</div>

...
export const resources = {
	...
	en: {
		translation: {
			// ===== ERROR CODES =====
			'ACCOUNT.EMAIL_INVALID': 'The provided email address is invalid.',
			'ACCOUNT.PASSWORD_TOO_WEAK': 'The password is too weak.',
			'ACCOUNT.ADRESS_MAXIMUM': 'Maximum number of addresses reached.',
			'ACCOUNT.INVALID_ADRESS': 'The provided address is invalid.',
			'ACCOUNT.CANNOT_REMOVE_PRIMARY_ADRESS': 'The primary address cannot be removed.',
			'ACCOUNT.PASSWORD_EMPTY': 'Password cannot be empty.',
			'ACCOUNT.PASSWORD_TOO_SHORT': 'Password must be at least 8 characters.',
			'ACCOUNT.PASSWORD_MISSING_UPPERCASE': 'Password must contain an uppercase letter.',
			'ACCOUNT.PASSWORD_MISSING_DIGIT': 'Password must contain a digit.',
			'ACCOUNT.NOT_FOUND': 'Account not found.',
			'ACCOUNT.ADDRESS_NOT_FOUND': 'Address not found.',
			'ACCOUNT.ALREADY_EXISTS': 'An account already exists with this email address.',
			'ACCOUNT.KVK_ALREADY_EXISTS': 'This KVK number is already registered.',
			'ACCOUNT.CREATION_FAILED': 'Account creation failed.',

			'KLOK.PRODUCT_NOT_IN_KLOK': 'The specified product is not part of the VeilingKlok.',
			'KLOK.INVALID_DURATION': 'The provided duration for the VeilingKlok is invalid.',
			'KLOK.INVALID_PEAK_VIEW': 'Invalid peak view count.',
			'KLOK.NOT_AVAILABLE_FOR_UPDATE': 'The VeilingKlok is not available for the requested update.',
			'KLOK.ALREADY_ENDED': 'The VeilingKlok has already ended.',
			'KLOK.INVALID_STATUS_TRANSITION': 'Invalid status transition for the VeilingKlok.',
			'KLOK.CANNOT_MODIFY_ENDED_KLOK': 'Cannot modify a VeilingKlok that has already ended.',
			...
			'ORDER.INVALID_ORDERED_ITEM': 'Invalid item in order.',
			...
			'PRODUCT.MINIMUM_PRICE_EXCEEDS_PRICE': 'Minimum price cannot exceed the starting price.',
			'PRODUCT.NEGATIVE_STOCK_VALUE': 'Stock cannot be negative.',
			'PRODUCT.NOT_FOUND': 'Product not found.',
			'PRODUCT.INSUFFICIENT_STOCK': 'Insufficient stock.',

			'VEILINGKLOK.NOT_FOUND': 'Veilingklok not found.',

			'CUSTOM.EXISTING_TRANSACTION': 'A transaction is already in progress.',
			'CUSTOM.ALREADY_ACTIVE_VEILING_IN_REGION': 'There is already an active veiling in this region.',
			'CUSTOM.JWT_CONFIG_MISSING': 'Internal server error: JWT configuration missing.',
			'CUSTOM.CANNOT_UPDATE_PRODUCT_LINKED_TO_ACTIVE_VEILING_KLOK': 'Cannot update product while it is linked to an active veilingklok.',
			'CUSTOM.INVALID_OPERATION': 'Invalid operation.',
			'CUSTOM.INVALID_CREDENTIALS': 'Invalid credentials.',
			...
			'CUSTOM.VEILING_KLOK_NOT_STARTED': 'The veilingklok has not started yet.',
			'CUSTOM.INVALID_VEILING_KLOK_STATUS': 'Invalid status for the veilingklok.',
			'CUSTOM.INVALID_VEILING_KLOK_PRODUCT_ID': 'Invalid product ID for the veilingklok.',
			'CUSTOM.INVALID_VEILING_KLOK_NO_PRODUCT': 'No product selected for the veilingklok.',
			'CUSTOM.CANNOT_CHANGE_RUNNING_VEILING_KLOK': 'Cannot change a running veilingklok.',
			'CUSTOM.CANNOT_DELETE_STARTED_VEILING_KLOK': 'Cannot delete a started veilingklok. Only scheduled ones can be deleted.',
			'CUSTOM.INVALID_OPERATION_KLOK_STILL_RUNNING': 'Operation not possible while the clock is still running.',
			'CUSTOM.TOKEN_GENERATION_FAILED': 'Error generating access token.',
			'CUSTOM.UNAUTHORIZED_ACCESS': 'Insufficient permissions for this action.',
			'CUSTOM.ACCESS_FORBIDDEN': 'Access forbidden.',
			'CUSTOM.INSUFFICIENT_PERMISSIONS': 'Insufficient permissions.',
			'CUSTOM.PRODUCT_ALREADY_LINKED_TO_VEILING_KLOK': 'Product is already linked to a veilingklok.',
			'CUSTOM.PRODUCT_NOT_LINKED_TO_VEILING_KLOK': 'Product is not linked to the veilingklok.',
			'CUSTOM.PRODUCT_ALREADY_IN_VEILING_KLOK': 'Product is already in the veilingklok.',

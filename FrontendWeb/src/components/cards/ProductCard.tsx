	...
	return (
		<div className="product-card">
			...
			<div className="product-card__content">
				{mode == 'meester' && <div className={clsx('product-card__badge !opacity-100 !scale-100 !z-10', product.auctionPlanned ? 'bg-green-500' : 'bg-yellow-400')}>{product.auctionPlanned ? t('scheduled_for_auction') : t('no_veiling_planned')}</div>}

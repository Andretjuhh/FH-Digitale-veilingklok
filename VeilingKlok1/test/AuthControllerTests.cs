...
namespace VeilingKlokApp.Tests;
...
public class AuthControllerTests
{
    ...
    public async Task Login_ReturnsOk_ForValidCredentials()
    {
        ...
        var result = await controller.Login(
            new LoginRequest { Email = account.Email, Password = "P@ssw0rd!" }
        );
        ...
        Assert.Equal(AccountType.Koper, payload.AccountType);
    }

    private sealed class FakeJwtService : IJwtService
    {
        public string GenerateAccessToken(Account account, AccountType accountType) => "token";
        ...
        public AccountType? GetAccountTypeFromToken(string token) => null;
    }
    ...
    private sealed class FakeAuthService : IAuthService
    {
        ...
        public Task<AuthResponse> SignInAsync(Account account, HttpResponse response)
        {

...
public class MeesterControllerTests
{
    ...
    {
        var controller = new MeesterController(mediator, new FakeSignInManager())
        {
    ...
    public async Task CreateMeesterAccount_WithValidData_ReturnsAuthOutputInHttpSuccess()
    {
        ...
        Assert.Equal(meesterId, success.Data);
    }
    ...
    public async Task CreateVeilingKlok_WithVeilingmeesterClaims_ReturnsCreatedVeilingKlokInHttpSuccess()
    {
        ...
        mediator.RegisterResponse<CreateVeilingKlokCommand, VeilingKlokDetailsOutputDto>(
            klokDetails
        );
    ...
    public async Task UpdateProductPrice_WithValidData_ReturnsUpdatedProductInHttpSuccess()
    {
        ...
        mediator.RegisterResponse<UpdateProductAuctionPriceCommand, ProductDetailsOutputDto>(
            details
        );

        var controller = CreateController(mediator);

        var result = await controller.UpdateProductPrice(Guid.NewGuid(), 2m);
    ...
    public async Task GetProducts_WhenCalled_ReturnsPaginatedProductsInHttpSuccess()
    {
        ...
        var result = await controller.GetProducts(null, null, null, null, null, 1, 10);
    ...
    public async Task UpdateVeilingKlokStatus_WithValidStatus_ReturnsNoContentHttpSuccess()
    {
        ...
        var result = await controller.UpdateVeilingKlokStatus(
            Guid.NewGuid(),

...
public class AccountControllerTests
{
    ...
    public async Task GetRegions_WhenCalled_ReturnsRegionsInHttpSuccess()
    {
        ...
        mediator.RegisterResponse<GetRegionsCommand, List<string>>(
            new List<string> { "Region1", "Region2" }
        );
    ...
    // [Fact]
    // Login is now handled by Identity API Endpoints
    /*
    ...
    */
    ...
    // [Fact]
    // Reauthenticate is now handled by Identity API Endpoints
    /*
